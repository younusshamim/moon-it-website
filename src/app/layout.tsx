...
export const metadata: Metadata = {
  ...
  keywords: [
    "Moon IT",
    "Moon IT training",
    "Moon IT training institute",
    "Moon IT Feni",
    "Moon IT training institute Feni",
    "MoonIT",
    "MoonIT Feni",
    "মুন আইটি",
    "মুন আইটি ফেনী",
    "মুন আইটি ট্রেনিং",
    "মুন আইটি ট্রেনিং ইনস্টিটিউট",
    "মুন আইটি ফেনী ট্রেনিং",
    "মুন আইটি ট্রেনিং ইনস্টিটিউট ফেনী",
    "best computer training center in Feni",
    "top computer training institute in Feni",
    "computer training Feni",
    "language training Feni",
    "IT courses Feni",
    "graphics design",
    "digital marketing",
    "AutoCAD",
    ...
    "fine arts in Feni",
    "ICT in Feni",
    "1-year diploma in fine arts in Feni",
    "1-year diploma in ICT in Feni",
    "1-year diploma course in Feni",
  ],
  openGraph: {
    images: [
      {
